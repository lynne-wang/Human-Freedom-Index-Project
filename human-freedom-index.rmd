...
_Limitations_
-Measured, not randomly sampled
-Connections in real world
-We did analysis but there are a lot of confounding variables

_Future Directions_
1. Continue to track specific gains and losses of freedom. 
2. Continue to identify and explain what links may exist among the assortment of freedoms and other variables
3. Explore the different relationships between freedoms at different levels of development
4. Determine if some types of freedom, economic or personal, are more conducive to the spread and sustenance of other freedoms
...
###NEED TO DO
-limitations section 
-future directions (where could we go deeper)
-finish presentation 
-linear regression stuff?
- general research question in introduction (see ppt ques. slide 5)