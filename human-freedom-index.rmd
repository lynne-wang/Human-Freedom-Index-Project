...
Great strides have been made globally and locally with regards to women's rights in the past century, even the past decade. However, around the world there are places where women's freedom is significantly hindered solely on the basis of their gender. Women may be refused access to political participation or education, die needlessly from childbirth, or just generally be prevented from making deeply personal choices in their private lives. Though child brides and genital mutilation may be the extremes on this scale, exploring women's freedoms and their relationship to other kinds of freedoms remains relevant. 

It is not surprising to see that women-specific freedoms and overall human freedom are postively correlated. 
