...
When considering countries that have fewer rights for women, it is also interesting to see how it is overall related to religious freedom, since there are examples where the two are (at least seemingly) linked. For example, in 

...outline remaining...
-developed countries have greater overall, also are further progressed on rights for women (source)
-economic freedom is not as strongly correlated because it is about aquisition and exchange of capital, economic activity, not as much personal choice. if personal choice is limited / heightened generally, makes sense that this would hold for women as well.
?what does this mean? ?future directions?
-since all positively correlated, if theres something standing in the way of womens freedoms, maybe work on something more attainable for now and eventually all will follow suit
-overall freedom is trending downward

-religious freedom / women freedom -> exemplify places where religious freedom very strict, so is womens (case study-ish, source (somewhere middle east?))
-discuss why sub saharan africa not fitting trend 
-discuss why oceania so high on both
-makes sense that they are linked explain why 
?what does this mean? ?future directions?
-only correlated, not causal, but increase one you'll prob eventually increase the other
-limiting personal choice can limit safety w/regards to strict religious guidelines

_Limitations_
Randomly sampled not measured
Connections to real world
We did analysis but there ar e a lot of confounding variables
