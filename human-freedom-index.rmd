...
### W-S freedom correlations 
Women-specific and overall freedom had an observed correlation coefficient of 0.505. This moderate, linear, positive correlation between the two variables tell us that countries with higher overall freedom scores are more likely to also have higher women-specific freedom scores, though the two are correlational, not causal. 

Women-specific and economic freedom had an observed correlation coefficient of 0.32. This weak-to-moderate positive linear correlation is less strong than the correlation between women-specific freedom and overall freedom, but still means that countries with higher economic freedom typically also have higher W-S freedom. There are a few outliers, like before, that had high W-S freedom but low economic freedom. 

Women-specific and personal freedom had an observed correlation coefficient of 0.56. This moderate positive linear correlation was quite similar to the correlation between women-specific freedom and overall freedom, indicating that countries with higher personal freedom typically also have higher W-S freedom. There are no obvious outliers, but a fairly large range of economic freedom scores that correspond to high women-specific freedom score, indicating that countries could have high or low economic freedom, but still have high women-specific freedom. 

We calculated the observed difference between correlation coefficients of women-specific vs economic freedom and women-specific vs personal freedom to be 0.24. 
...
Economic freedom is slightly higher than personal freedom in developing countries, particularly in the Middle East & North Africa. Meanwhile, personal freedom scores appear to be significantly higher than economic freedom scores in developed countries, particularly in Western Europe(and in Western countries overall).

There is a moderate to strong positive correlation between economic freedom score and personal freedom score.

Economic freedom scores tend to be lower than personal freedom scores around the world.

There is a difference in the relationship between government size and overall human freedom depending on a country’s Cold War status. Previously Soviet countries’ governments have been decreasing in size. Western countries’ governments have been increasing in size. Post-Soviet countries have smaller governments on average compared to Western countries. Smaller government does not necessarily lead to greater overall human freedom. 
...
In our analysis of the Human Freedom Index dataset, there are clear limitations that need to be recognized. One such limitation is that the data is not randomly selected and does not contain the randomness that is typically desired from a dataset. Another limitation is that though analysis was performed, it was done so in a manner that assumed the individual countries to be independent and not have regional factors that affected each others scores in one or more categories. This presence of confounding variables somewhat decreases the validity of the analysis since it is easy to recognize that regional conflicts would affect certain freedom scores rather than solely the policies or type of government present in a given country. 

_Future Directions_

If this project were to continue in the future there are a few key areas that would require further attention. First, it is necessary to continue tracking changes in freedom over time. Likewise, it is critical that further possible relationships be identified and explored among the assortment of freedoms and other variables. Another key area relates to exploring the different relationshops between freedom levels at different levels of development. Lastly, it would be greatly beneficial to determine if certain types of freedom (economic or social) are more likely to enable or allow other freedoms to emerge or be sustained. 
...
###NEED TO DO
-finish presentation 
-other things that I might be missing.
- look over the rmd (perform edits)
- 